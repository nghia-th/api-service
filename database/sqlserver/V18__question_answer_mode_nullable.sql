...
-- constraint (existing rows keep their current value, nothing is backfilled - the existing
-- unnamed DEFAULT CONSTRAINT on this column is a separate object and is left untouched).
ALTER TABLE question ALTER COLUMN answer_mode NVARCHAR(20) NULL;
