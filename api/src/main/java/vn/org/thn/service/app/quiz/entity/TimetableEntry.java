...
/**
 * One {@link Subject} scheduled on one day-of-week of a {@link Classroom}'s weekly timetable
 ...
 * <p>
 * <b>Revision 2026-09-06:</b> originally pinned an exact {@link Lesson} (AskUserQuestion
 ...
 * Subject->Classroom on every read, since a Classroom's whole-week timetable is read far more
 * often than any single entry is edited) - see {@code TimetableService#getOwnedOrThrow}, and
